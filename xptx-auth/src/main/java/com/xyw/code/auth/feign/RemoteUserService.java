package com.xyw.code.auth.feign;

import com.xyw.code.auth.feign.factory.RemoteLogFallbackFactory;
 ...
 */
@FeignClient(name = ServiceNameConstants.SYSTEM_UMPS_SERVICE,fallbackFactory = RemoteLogFallbackFactory.class)
